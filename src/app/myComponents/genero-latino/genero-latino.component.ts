...
@Component({
  selector: 'app-genero-latino',
  templateUrl: './genero-latino.component.html',
  styleUrls: ['./genero-latino.component.css']
})
export class GeneroLatinoComponent implements OnInit {
