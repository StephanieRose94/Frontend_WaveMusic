...
@Component({
  selector: 'app-genero-urbana',
  templateUrl: './genero-urbana.component.html',
  styleUrls: ['./genero-urbana.component.css']
})
export class GeneroUrbanaComponent implements OnInit {
