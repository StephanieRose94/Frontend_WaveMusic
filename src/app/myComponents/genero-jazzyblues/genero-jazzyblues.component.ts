...
@Component({
  selector: 'app-genero-jazzyblues',
  templateUrl: './genero-jazzyblues.component.html',
  styleUrls: ['./genero-jazzyblues.component.css']
})
export class GeneroJazzybluesComponent implements OnInit {
